...
company_descriptions = {
    "HDFC Bank": "HDFC Bank is one of India's leading private sector banks, providing a wide range of financial services. "
                 ...
                 "The bank is known for its strong emphasis on customer service, innovative products, and extensive branch network, making it a preferred choice for millions of customers.",
    ...
    "Infosys": "Infosys is a global leader in technology services and consulting, enabling clients in more than 50 countries. "
               ...
               "The company is renowned for its commitment to innovation, sustainability, and corporate social responsibility, making it a trusted partner for businesses worldwide. "
    ...
    "Wipro": "Wipro is a leading global information technology, consulting, and business process services company. "
             ...
             "Wipro is recognized for its commitment to innovation, sustainability, and social responsibility, making it a trusted partner for businesses worldwide. "
...
Please save these changes to dashboard.py and commit them to your repository.
reduce one line from each of the descriptions

1 reference
Here is the modified dashboard.py with one line reduced from each company description:
